...
CREATE TABLE `order` (
  ...
  CONSTRAINT `client_name` FOREIGN KEY (`name`) REFERENCES `client` (`name`)
...
INSERT INTO `order` VALUES (1,'Luca George',15,0);
...
CREATE TABLE `orderItem` (
  ...
  CONSTRAINT `product_name` FOREIGN KEY (`name`) REFERENCES `product` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `orderItem` VALUES (1,'apple',5),(1,'lemon',5);
...
-- Dump completed on 2020-04-12 15:17:10
